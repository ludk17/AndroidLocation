...
import com.lumenagile.mapafinal.services.MyLocationService;
...
public class MainActivity extends AppCompatActivity implements ConnectionCallbacks, OnConnectionFailedListener, LocationListener
{
    ...
    private void setCurrentLocation() {
        ...
        MyLocationService service = new MyLocationService(getApplicationContext());
        service.saveLocation(currentLongitude, currentLatitude);
    }
